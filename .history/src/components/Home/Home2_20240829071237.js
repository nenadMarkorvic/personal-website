          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              ✔  Electronic Circuit & <i>
                <b className="purple">PCB design </b>
              </i>, manufacturing and testing support.
              <br />
              ⚡Switching <i>
                <b className="purple">power supply circuits</b>
              </i> and PCB design: DC-DC, AC-DC and DC-AC converters.
              <br />
              ⚡LED lighting driver circuits and PCB design.
              <br />
              ⚡<i>
                <b className="purple">High</b>
              </i> speed and multi-layers PCB design for embedded system application.
              <br />
